...
if DEFINED OLD_Ruby_Version_00 (
if DEFINED OLD_Ruby_Version_01 (
set "OLD_Ruby_Version_02=%OLD_Ruby_Version_01%"
)
set "OLD_Ruby_Version_01=%OLD_Ruby_Version_00%"
)
set "OLD_Ruby_Version_00=%Ruby_Version%"
)
set "Ruby_Version=31"
set "Now_AllVENV= "
...
cd /d ..\%ActivatingEnv%\%ActivatingEnv%%Ruby_Version%\
set "OLD_PATH=%PATH%"
set "Ruby_VENV=%cd%;%cd%\bin"
...
echo ###################################
echo ## [96m%ActivatingEnv%%Ruby_Version%[0m Virtual Env BY Unknown ##
echo ###################################
...
if DEFINED OLD_Ruby_Version_00 (
set "Ruby_Version=%OLD_Ruby_Version_00%"
set "OLD_Ruby_Version_00="
)else (
set "Ruby_Version="
)
if DEFINED OLD_Ruby_Version_01 (
set "OLD_Ruby_Version_00=%OLD_Ruby_Version_01%"
set "OLD_Ruby_Version_01="
)
if DEFINED OLD_Ruby_Version_02 (
set "OLD_Ruby_Version_01=%OLD_Ruby_Version_02%"
set "OLD_Ruby_Version_02="
)