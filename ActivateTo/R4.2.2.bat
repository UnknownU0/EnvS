...
set "OLD_R_Version_02=%OLD_R_Version_01%"
)
set "OLD_R_Version_01=%OLD_R_Version_00%"
)
set "OLD_R_Version_00=%R_Version%"
)
set "R_Version=4.2.2"
set "Now_AllVENV= "
...
cd /d ..\%ActivatingEnv%\%ActivatingEnv%%R_Version%\
set "OLD_PATH=%PATH%"
set "R_VENV=%cd%;%cd%\bin;%cd%\bin\x64"
