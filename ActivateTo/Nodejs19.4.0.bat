...
set "OLD_Nodejs_Version_02=%OLD_Nodejs_Version_01%"
)
set "OLD_Nodejs_Version_01=%OLD_Nodejs_Version_00%"
)
set "OLD_Nodejs_Version_00=%Nodejs_Version%"
)
set "Nodejs_Version=19.4.0"
set "Now_AllVENV= "
...
cd /d ..\%ActivatingEnv%\%ActivatingEnv%%Nodejs_Version%\
set "OLD_PATH=%PATH%"
set "Nodejs_VENV=%cd%;%cd%\node_modules\npm\bin"
