...
set "OLD_Go_Version_02=%OLD_Go_Version_01%"
)
set "OLD_Go_Version_01=%OLD_Go_Version_00%"
)
set "OLD_Go_Version_00=%Go_Version%"
)
...
cd /d ..\%ActivatingEnv%\%ActivatingEnv%%Go_Version%\
set "OLD_PATH=%PATH%"
set "Go_VENV=%cd%;%cd%\bin"
