...
set "OLD_Perl_Version_02=%OLD_Perl_Version_01%"
)
set "OLD_Perl_Version_01=%OLD_Perl_Version_00%"
)
set "OLD_Perl_Version_00=%Perl_Version%"
)
set "Perl_Version=5.32.1.1-32bit"
set "Now_AllVENV= "
...
cd /d ..\%ActivatingEnv%\%ActivatingEnv%%Perl_Version%\
set "OLD_PATH=%PATH%"
set "Perl_VENV=%cd%;%cd%\bin"
