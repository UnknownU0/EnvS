...
set "OLD_C_Version_02=%OLD_C_Version_01%"
)
set "OLD_C_Version_01=%OLD_C_Version_00%"
)
set "OLD_C_Version_00=%C_Version%"
)
set "C_Version=_cmake3.25.1-x86"
set "Now_AllVENV= "
...
cd /d ..\%ActivatingEnv%\%ActivatingEnv%%C_Version%\
set "OLD_PATH=%PATH%"
set "C_VENV=%cd%;%cd%\bin"
